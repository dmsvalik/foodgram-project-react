    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Введено некорректное значение поля "username"', regex='^[\\w.@+-]+\\Z')], verbose_name='Ник пользователя')),
